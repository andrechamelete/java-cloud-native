...
public class AgendaEventos {
    ...
    public static void main(String[] args) {
        ...
        agendaEventos.adicionarEvento(LocalDate.of(2024, Month.JANUARY,10), "Evento 2", "Atracao 2");
        agendaEventos.adicionarEvento(LocalDate.of(2025, 7, 9), "Evento 3", "Atracao 3");
        agendaEventos.adicionarEvento(LocalDate.of(2025, Month.JULY, 1), "Evento 4", "Atracao 4");
